...
Creating a user.
```ruby
irb > u = User.create name: "user"
   (0.2ms)  BEGIN
  SQL (0.3ms)  INSERT INTO `users` (`created_at`, `name`, `updated_at`) VALUES ('2013-06-10 03:44:27', 'user', '2013-06-10 03:44:27')
   (0.7ms)  COMMIT
=> #<User id: 1, name: "user", created_at: "2013-06-10 03:44:27", updated_at: "2013-06-10 03:44:27">
```
Changing its name.
```ruby
irb > u.change_name_after_10_minutes

   (sleeping 10 seconds...)

   (0.2ms)  BEGIN
   (0.4ms)  UPDATE `users` SET `name` = 'user_1370835903', `updated_at` = '2013-06-10 03:45:03' WHERE `users`.`id` = 1
   (0.8ms)  COMMIT
=> true
```
Reloading the user.
...
=> #<User id: 1, name: "user_1370835997", created_at: "2013-06-10 03:44:27", updated_at: "2013-06-10 03:46:37">
```
